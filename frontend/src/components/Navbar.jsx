...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, navigate, setToken, token, setCartItems } = useContext(ShopeContext);
    ...
    return (
        <div className='flex item-center justify-between py-5 font-medium'>
            ...
            <div className={`absolute top-0 right-0 botoom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'} `}>
